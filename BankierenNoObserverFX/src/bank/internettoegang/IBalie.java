...
public interface IBalie extends Remote {
     ...
     * is identificerend voor de nieuwe bankrekening en heeft een saldo van 0
     * euro
     *
     ...
     * @return null zodra naam of plaats een lege string of wachtwoord minder
     * dan vier of meer dan acht karakters lang is en anders de gegenereerde
     * accountnaam(8 karakters lang) waarmee er toegang tot de nieuwe
     * bankrekening kan worden verkregen
     */
     ...
     * @param accountnaam
     * @param wachtwoord
     * @return de gegenereerde sessie waarbinnen de gebruiker toegang krijgt tot
     * de bankrekening die hoort bij het betreffende login- account mits
